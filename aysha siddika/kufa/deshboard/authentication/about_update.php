              ...
              <div class="col-md-6">
                                <div class="card ">
                                    <div class="card-header">
                                        <h5 class="card-title">Update about service</h5>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                       ...
                                       unset( $_SESSION['sucess_data']);
                                        ...
                                        <div class="example-container">
                                            <div class="example-content">
                                                ...
                                                <?php
                                                include_once('./fontand/icon2.php');
                                               ...
                                               <?php 
                                                ...
                                                $about_select_querry="SELECT * FROM `abouts` WHERE id='$id'";
                                                $about_select_querry_db=mysqli_query($conect_database, $about_select_querry);
                                                $about_select_querry_db_arry=mysqli_fetch_assoc($about_select_querry_db);
                                                
                                                ?>  
                                                
                                                <input hidden type="number" name="id" value="<?=$about_select_querry_db_arry['id']?>">
                                                ...
                                                value="<?=$about_select_querry_db_arry['service_icon']?>">

                                                <label>service value</label>
                                                <input type="number" class="form-control form-control-solid-bordered m-b-sm" aria-describedby="solidBoderedInputExample"  name="service_value" 
                                                value="<?=$about_select_querry_db_arry['service_value']?>">
                                                ...
                                                value="<?=$about_select_querry_db_arry['service_tittle']?>">
                                                ...
                                                placeholder=""
                                                > <?=$about_select_querry_db_arry['service_description']?> </textarea>
                                                
                                               <button class="btn btn-info" style="width:100%;padding:10px">update about service</button>
                                                </form>
                                            </div>
                                        </div>
