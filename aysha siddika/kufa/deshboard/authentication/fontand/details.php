...
<head>
    ...
    <body class="theme-bg">
        ...
        <main>
           ...
           $details_select_querry="SELECT * FROM `imageservices` WHERE id='$id'";
           $details_select_querry_db=mysqli_query($conect_database, $details_select_querry);
           $details_select_querry_db_arry=mysqli_fetch_assoc($details_select_querry_db);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                ...
                                <div class="blog-list-thumb mb-35">
                                    <img src="../uploade/gallery/<?=$details_select_querry_db_arry['service_image']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$details_select_querry_db_arry['service_heading']?></h2>
