              ...
              <div class="col-md-6">
                                <div class="card ">
                                    <div class="card-header">
                                        <h5 class="card-title">Add about service</h5>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                        ...
                                        <div class="example-container">
                                            <div class="example-content">
                                                ...
                                                foreach ($fonts as $font) { ?>
                                                    <span class="card-text badge badge-info m-1 "style="cursor: pointer ">
                                               ...
                                               <button class="btn btn-info" style="width:100%;padding:10px">Add about service</button>
                                                </form>
                                            </div>
                                        </div>
